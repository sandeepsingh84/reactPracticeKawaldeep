...
const PracticeOfToDoList = ({itemList,setdateItemList}) => {
...
// const resultFilter = dummyArray?.filter((item)=> item !== 'cde') 
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {itemList.map((ee) => (
              <div
                ...
                className="flex justify-between shadow-md hover:bg-blue-100"
              >
                <p className="pb-1">{ee}</p>
                ...
                <svg
                  ...
                  class="bi bi-trash"
                  viewBox="0 0 16 16"
                  className="mr-4 text-red-500 font-bold hover:text-white"
                  onClick={() => {
                    const filterItem = itemList?.filter((kk) => kk !== ee);
                    setdateItemList(filterItem)
          ...
          {/* <div
            style={{
              ...
              borderRadius: "25px",
              boxShadow:
                "inset 8px 8px 8px #94acd6, inset -8px -8px 8px #94acd6",
            }}
          >
            <svg
              style={{ height: "25px", width: "25px", marginTop: "20px" }}
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
              fill="currentColor"
        ...
        >
          ...
          <svg style={{width:'25px',height:'25px',marginRight:'20px',marginTop:'7px'}}xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
  <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
